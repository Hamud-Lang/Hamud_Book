...
- **作者：`@希腊火Onerio` 创建于 V2022-12-15-1**
- **修改：`@PJ568` 修改于 V2023-07-29 16:00**

## 前言

> **`@希腊火Onerio` 发表于 2022-12-14**
>
> 哈姆语是一门起源于网络流行meme，语法基于道本语、词汇基于阿拉伯词源的人造语言。2022年10月13日b站用户“希腊火Onerio”在B站上传了第一个哈姆语视频，一周之内就突破了10万播放量。后虽账号被误封，视频迁移，经历了无数磨难后，哈姆语依然逐渐完善，并形成了哈姆语社区。
>哈姆语拥有完善的语法和词汇，并且其背后拥有一套独特的世界观。由于词汇的不断扩充以及语法体系的日渐完善，应各位观众要求，特此编写《新标准哈姆语》。
